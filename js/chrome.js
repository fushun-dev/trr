...
(function () {
    ...
    <div class="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
      <a href="index.html" class="flex items-center gap-2">
        ...
        <div class="leading-tight">
          ...
          <p id="brand-status" class="text-[11px] font-semibold flex items-center gap-1 text-gray-400"><span class="w-1.5 h-1.5 rounded-full bg-gray-300"></span> —</p>
        </div>
      </a>
  ...
  <div id="admin-preview-bar" class="hidden bg-amber-100 text-amber-800 text-xs text-center py-1.5 px-4 font-bold" data-i18n="preview.admin">Admin preview — viewing only</div>
