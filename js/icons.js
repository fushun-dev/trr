...
(function () {
  ...
  const ICONS = {
    ...
    gear: P('<circle cx="12" cy="12" r="3"/><path d="M12 2.5l1.3 2.2 2.5-.5.4 2.5 2.3 1-1 2.3 1 2.3-2.3 1-.4 2.5-2.5-.5L12 21.5l-1.3-2.2-2.5.5-.4-2.5-2.3-1 1-2.3-1-2.3 2.3-1 .4-2.5 2.5.5z"/>'),
